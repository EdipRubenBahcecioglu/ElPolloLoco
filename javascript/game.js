...
function init(){
    ...
    world = new World(canvas, keyboard, backgroundMusic); // Wir legen eine neues Objekt (World) an und geben das HTML Element Canvas (Spielfeld) mit // Der Parameter Canvas wird dem Constructor aus der Klasse World weitergegebens
    playBackgroundMusic();
    checkGameStatus();
}
