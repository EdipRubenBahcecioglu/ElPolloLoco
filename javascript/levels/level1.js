...
function createLevelBackground() {
    return [// Unser Char startet mit Zeile 28 bei der X Achse 0, wenn er die Canvasbreite nach rechts weiterläuft, verschieben wir unsere Map ab Zeile 33 nach rechts, dasselbe wenn Char nach links läuft
